...
<div class="banner">
  <div id="inner">
    <div class="hot-event">
      ...
      <div class="event-item" style="background-color:#c20000; background-image:url(/index/upload/img4.jpg);"><a href="index.html" title="十七金融"></a></div>
      <div class="event-item" style="background-color:#c20000; background-image:url(/index/upload/img4.jpg);"><a href="index.html" title="十七金融"></a></div>
      <div class="event-item" style="background-color:#c20000; background-image:url(/index/upload/img4.jpg);"><a href="index.html" title="十七金融"></a></div>
...
<div class="Platform-data">
  <div class="hd">
    <div class="wrap clearfix">
      ...
      <div class="data fr">
        <div class="item"><span class="count">3,322</span>人实现借款</div>
        <div class="item"><span class="count">3,322</span>人成功投资</div>
        <div class="item"><span class="count">3,322</span>笔成功投资</div>
        <div class="item"><span class="count">3,322</span>万元成交金额</div>
      </div>
    </div>
  </div>
...
<div class="wrap mt10 clearfix">
  <div class="indexsection fl">
      ...
      <div class="bd clearfix">
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(/index/images/100.png) no-repeat center;">100%</div>
        ...
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(/index/images/75.png) no-repeat center;">75%</div>
            <a href="invest-list.html" class="ico btn-Tender">投标</a>
            剩余金额 250,000元
          </div>
        </div>
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(/index/images/50.png) no-repeat center;">50%</div>
            <a href="invest-list.html" class="ico btn-Tender">投标</a>
            剩余金额 250,000元
          </div>
        </div>
    ...
    <div class="Recommendation mt10 bdr">
      ...
      <dl>
        <dt class="clearfix"><a href="#" class="button ico Repayment">还款中</a><em class="ico Guarantee">保</em>园博印象旅游珠宝商户进货<span class="Guarantee-Agency">  担保机构：安徽融桥担保股份有限公司</span></dt>
        <dd>
      ...
      <dl>
        <dt class="clearfix"><a href="invest-list.html" class="button ico Bid">投标</a><em class="ico Guarantee">保</em>园博印象旅游珠宝商户进货<span class="Guarantee-Agency">  担保机构：安徽融桥担保股份有限公司</span></dt>
        <dd>
  ...
  <div class="indexaside fr">
    ...
    <div class="mt10 bd bdr">
      ...
      <div class="reports mt10 clearfix">
        <dl class="clearfix">
          <dt class="img"><a href="reportshow.html"><img src="/index/upload/img5.jpg"></a></dt>
          <dd><a href="newshow.html">互联网金融应该充当毛细血管的角色-上海法治声音</a></dd>
        </dl>
        <dl class="clearfix">
          <dt class="img"><a href="reportshow.html"><img src="/index/upload/img6.jpg"></a></dt>
          <dd><a href="newshow.html">互联网金融应该充当毛细血管的角色-上海法治声音</a></dd>
        </dl>
      </div>
    ...
    <!--ad-->
    <div class="ad img mt10"><a href="#" class="btn-reg"><img src="/index/upload/img7.jpg"></a></div>
    
    <!--about-->
    <div class="mt10 bd bdr">
      <div class="hd clearfix"><a href="about.html" class="more">更多&gt;&gt;</a>关于我们</div>
      <div class="txt clearfix">万国集团成立于2009年，是专业从事商业地产开发、运营、管理及小额贷款等融资投资机构，由占安徽服饰市场三分天下的众多实力品牌省级代理商联合打造。自成立以来，始终秉承“全力塑造优质地产品牌，全心服务社会建设目标”的商业宗旨，致力于推进安徽服装商业地产的全面升级。</div>
    </div>
